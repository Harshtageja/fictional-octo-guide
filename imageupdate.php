...
<h1>Your Image</h1>
<form action="http://localhost/imageupdate2.php" method="post" enctype="multipart/form-data">
    <label>Select Image File:</label>
    <input class="v" type="file" name="image">
...
?>
<button type="submit" name="submit">continue</button><br><br>

</form>
<form method="post" action="http://localhost/recentimage.php">
	<input type="text" name="Email" style="display: none" value="<?php echo $_POST['Email'] ?>">
	<button type="submit">Recent Images</button>
